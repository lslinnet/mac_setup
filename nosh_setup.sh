...
do
        ...
        case "$CHOICE" in
				...
				"5")	echo "5 get Nosh"
						...
						wait
						echo "cloning Nosh..."
						git clone git@github.com:WKLive/nosh.git
						wait
						echo ""
						;;
                ...
                "0")	echo ""
                		echo "# Note"
                		echo "Please run Vagrant before testing Nosh:"
						echo ""
						echo "$ vagrant box add base http://files.vagrantup.com/lucid32.box"
						echo "$ vagrant init"
						echo "$ vagrant up"
						echo ""
						echo "Then make sure to Power off the Vagrant VM instance."
						echo "Reboot and you should be good to go."
						echo ""
                		exit
                        ;;
        esac
