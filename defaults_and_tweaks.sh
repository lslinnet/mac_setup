...
# Sensible Mac OS X defaults and tweaky settings
# Script based on https://github.com/mathiasbynens/dotfiles/blob/master/.osx
...
sudo scutil --set ComputerName "adapt-lslinnet"
sudo scutil --set HostName "adapt-lslinnet"
sudo scutil --set LocalHostName "adapt-lslinnet"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "adapt-lslinnet"
...
# Turn off keyboard illumination when computer is not used for half a minutes
...
default write com.apple.dock wvous-br-modifier -int 0
